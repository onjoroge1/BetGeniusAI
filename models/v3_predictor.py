"""
V3 LightGBM Prediction Service - Sharp Book Intelligence Model

Loads trained V3 model with 34 features:
- V2 Odds (17): Market probabilities, dispersion, volatility, drift
- Sharp Book (4): Pinnacle/Betfair sharp odds, soft vs sharp divergence
...
class V3Predictor:
    """
    V3 LightGBM prediction service with Sharp Book Intelligence
    
    Features:
    - 34-feature pipeline (V2 + Sharp + ECE + Injuries + Timing)
        ...
        Returns:
            {
                ...
                'model': 'v3_sharp',
                'features_used': count of non-zero features
            }
        """
        try:

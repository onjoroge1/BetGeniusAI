...
- **LightGBM Development**: Validated pipeline with fixed label encoding (H=0, D=1, A=2). Market-only baseline achieves 47.8% hit rate, -0.098 LogLoss vs V2 Ridge on 462 samples. Ready for enriched training with historical features targeting 55-60% hit rate at ≥1,000 samples.
...
- **Historical Match Data**: 14,527 matches (1993-2024) across 6 major leagues with results, odds, and in-game statistics (shots, corners, cards). Powers historical feature engineering pipeline.
